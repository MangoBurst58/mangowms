...
@section('title', 'Edit Supplier | MangoWMS')
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="flex items-center gap-4 mb-6">
        <a href="{{ route('suppliers.index') }}" class="text-gray-400 hover:text-white">
    ...
    <div class="bg-slate-800 rounded-xl border border-slate-700 p-6">
        <form action="{{ route('suppliers.update', $supplier) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                    <label class="block text-sm font-medium text-gray-300 mb-2">Supplier Code *</label>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-300 mb-2">Supplier Name *</label>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="address" rows="3" 
                              class="w-full bg-slate-900 border border-slate-700 rounded-lg px-4 py-2 text-white focus:border-indigo-500 focus:outline-none">{{ old('address', $supplier->address) }}</textarea>
                </div>
            ...
            <div class="flex justify-end gap-3 mt-6 pt-4 border-t border-slate-700">
                <a href="{{ route('suppliers.index') }}" class="px-4 py-2 bg-slate-700 hover:bg-slate-600 text-white rounded-lg transition">
                    Cancel
                </a>
